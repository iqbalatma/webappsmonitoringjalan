class RoutingmachineClass{
    constructor(koordinatejalanrusak){
        ...
        this.koordinatejalanrusak;

        this.titikJalanRusakFinal;
    ...
    set_on_routing_error(){
        return this.control_routing.on('routingerror', function(e) {
            console.log(e);
        })
    }

    set_on_route_found(){
        return this.control_routing.on('routesfound', function(e) {
            console.log("haha");
            ...
            // // perulangan untuk mengecek data jalan rusak ada database, berarti perulangan paling luar adalah data pada database
            ...
            //         jarak = object_devicelocation.distance(lat1, long1, lat2, long2, "M");
            ...
            //     this.titikJalanRusakFinal = jalanRusakYangDilaluiFilteredSecondStep;
            ...
            //     for (let i = 0; i < this.titikJalanRusakFinal.length; i++) {
            //         demo[i] = L.Routing.control({
            //             fitSelectedRoutes: false,
            //             useZoomParameter: false,
            //             waypoints: [
            //                 L.latLng(this.titikJalanRusakFinal[i][0], this.titikJalanRusakFinal[i][1]),
            //                 L.latLng(this.titikJalanRusakFinal[i][0], this.titikJalanRusakFinal[i][1]),
            //             ],
            //             lineOptions: {
            //                 styles: [{
